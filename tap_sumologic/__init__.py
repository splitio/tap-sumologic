...
from tap_sumologic.discover import discover_streams
from tap_sumologic.sync import sync_stream
from tap_sumologic.config import CONFIG_CONTRACT

LOGGER = singer.get_logger()

REQUIRED_CONFIG_KEYS = ["start_date", "sumologic_access_id", "sumologic_access_key", "sumologic_root_url"]
